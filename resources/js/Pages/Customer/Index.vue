        ...
        <div class="border-2 border-dashed rounded-lg border-gray-300 dark:border-gray-600 mb-4">
            <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                ...
                <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                    ...
                    <tbody>
                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700" v-for="customers in data.data" :key="customers.id">
    ...
    export default {
        ...
        watch: {
            ...
            handler: throttle(function () {
                this.$inertia.get('/master/customer', pickBy(this.form), { preserveState: true })
            }, 150),
            },
        },
        methods: {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    router.delete(route('customer.destroy', productId));
                }
            })
        }
        },
