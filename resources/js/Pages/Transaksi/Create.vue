                    ...
                    <form @submit.prevent="submit">
                        ...
                        <div>
                            ...
                            <TextInput id="sku" v-model="form.sku" type="text" class="mt-1 block xl:w-1/2 w-full" required
                                autofocus placeholder="Ex. C00001" autocomplete="off" />
...
export default {
    ...
    setup() {
        ...
        const submit = () => {
            transaction_number.value = generateTransactionNumber();
            localStorage.setItem('lastTransactionNumber', transaction_number.value);
